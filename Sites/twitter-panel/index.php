...
<input class="form-control girisinput" placeholder="Kullanıcı Adınız" type='text' style='width:220px; text-align:center;margin-top:10px;' maxlength='30' name='login' value=''><br>
<input class="form-control girisinput" placeholder="Şifreniz" type='password' style='width:220px; text-align:center;margin-top:10px;' maxlength='255' name='password' value=''><br><br>
<br>
